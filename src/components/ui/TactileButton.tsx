...
export type ButtonVariant = 'green' | 'blue' | 'orange' | 'red' | 'yellow' | 'gray' | 'outline';
...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  orange: 'bg-duo-orange border-duo-orange-border text-white hover:brightness-105',
  red: 'bg-duo-red border-duo-red-border text-white hover:brightness-105',
  yellow: 'bg-duo-yellow border-duo-yellow-border text-duo-dark hover:brightness-105',
  gray: 'bg-duo-gray border-duo-gray-border text-duo-dark/50 hover:brightness-100',
  outline: 'bg-white border-duo-gray border-b-duo-gray-border border-r-duo-gray-border text-duo-dark hover:bg-slate-50',
};
...
export const TactileButton = React.forwardRef<HTMLButtonElement, TactileButtonProps>(
  (
    ...
    return (
      ...
      >
        {isLoading ? (
          <span className="inline-flex items-center gap-1.5 py-0.5" aria-label="Loading">
