...
const TrueFalseEditor: React.FC<EditorProps<TrueFalseContent>> = ({
  value,
  onChange,
}) => {
  return (
    <div className="flex flex-col gap-4 p-4 bg-white rounded-2xl border-2 border-[#E5E5E5]">
      <label className="font-bold text-sm text-[#4B4B4B]">
      ...
      <div className="flex gap-4 items-center mt-2">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-xl font-extrabold border-2 border-solid active:translate-y-0.5 transition-all ${
            value.isCorrectTrue
...
export const trueFalsePlugin: QuestionPlugin<TrueFalseContent, boolean> = {
  ...
  validateAnswer: (
    ...
    return {
      ...
      feedback: isCorrect
        ? "Luar biasa, jawaban kamu tepat!"
        : "Kurang tepat, coba ingat lagi materinya ya!",
    };
  },
