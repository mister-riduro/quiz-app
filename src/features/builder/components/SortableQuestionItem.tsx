  ...
  return (
    <div
      ...
      className={cn(
        ...
        isActive && 'border-duo-blue border-b-duo-blue-border bg-duo-blue-light/15 ring-2 ring-duo-blue/30',
        // Dragging State
        isDragging && 'opacity-70 shadow-xl scale-105 border-duo-orange border-b-duo-orange-border'
      )}
    >
      {/* Drag Handle */}
      <div
