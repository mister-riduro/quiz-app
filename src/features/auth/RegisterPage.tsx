      ...
      <DuoCard elevated className="w-full flex flex-col gap-6 p-6 sm:p-8 text-center">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-xs sm:text-sm font-semibold text-[#777777] mt-1.5">
            Mulai rancang kuis interaktif kelas gratis untuk siswa Anda
          </p>
        </div>

        {/* Friendly Error Bubble Alert */}
        {displayedError && (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-left">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Budi Rahardjo, S.Pd."
          ...
          <div>
            <label className="block text-xs font-black uppercase text-slate-400 mb-1.5 tracking-wider">
              Nama Sekolah / Madrasah (Opsional)
            </label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
        ...
        <div className="pt-2 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-center gap-1.5 text-xs sm:text-sm font-bold text-[#777777]">
          <span>Sudah memiliki akun guru?</span>
          <button
            type="button"
            onClick={() => {
              playTap();
