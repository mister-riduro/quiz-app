...
export const useBuilderStore = create<BuilderState>()(
  persist(
    (set, get) => ({
      ...
      setGlobalTimeLimit: (seconds: number) =>
        set((state) => ({
          currentQuiz: {
            ...state.currentQuiz,
            globalTimeLimitSeconds: seconds,
          },
          isDirty: true,
        })),
      ...
      saveQuiz: async () => {
        ...
        const storedQuiz: StoredQuiz = {
          ...
          globalTimeLimitSeconds:
            state.currentQuiz.globalTimeLimitSeconds ?? 7200,
    ...
    {
      name: "eduplay-builder-storage",
      storage: createJSONStorage(() => localStorage),
      partialize: (state) => ({
        currentQuiz: state.currentQuiz,
        questions: state.questions,
        activeQuestionIndex: state.activeQuestionIndex,
        defaultQuestionTimeLimitSeconds: state.defaultQuestionTimeLimitSeconds,
